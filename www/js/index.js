...
var app = {
    ...
    selectDev: function(e){
     document.getElementById("selectedDeviceName").innerHTML = e.target.dataset.deviceName;
    ...
    refreshDeviceList: function() {
        ...
        ble.scan([], 3, app.onDiscoverDevice, app.onError);
    },
    ...
    startFOTA: function(event) {
            ...
            var file = document.getElementById("selectImage").value;
           if (file == null||file == ""){
                                document.getElementById("ota_text").innerHTML = "Please select a file first";
                                return false;
            }else{
                    document.getElementById("ota_text").innerHTML = "Upgrading OTA";
            }
                ...
                function ack_read(data)
                {
                    ...
                    if(all_acked)
                    {
                      ...
                      //  document.getElementById("ota_text").innerHTML = "" +sector_idx/sector_max +"";
                         document.getElementById("ota_text").innerHTML = "progress rate：" +Math.round(sector_idx/sector_max*100) +"%";
